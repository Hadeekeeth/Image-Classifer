...
trainloader, v_loader, testloader = imp.load_data(where)
...
imp.train_network(model, optimizer, criterion, epochs, 20, trainloader, power)


imp.save_checkpoint(path,structure,hidden_layer1,dropout,lr)
