...
ap.add_argument('input_img', default='flowers/test/26/image_06497.jpg', nargs='*', action="store", type = str)
...
probabilities = imp.predict(path_image, model,number_of_outputs, power)
