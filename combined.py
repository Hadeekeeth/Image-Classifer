...
def train_network(model,optimizer,criterion,loader,print_every,epochs = 3,power='gpu'):
    '''
...
trainloader, v_loader, testloader = load_data(where)

model, optimizer, criterion = nn_setup(structure,dropout,hidden_layer1,lr,power)


train_network(model, optimizer, criterion,trainloader,20, epochs,  power)
